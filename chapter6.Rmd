...
arguments ของ function `list()` คือส่วนประกอบที่คุณจะใส่ลงไปใน list จำไว้ว่าส่วนประกอบเหล่านี้สามารถเป็นได้ทั้ง matrices, vectors, หรือแม้กระทั่ง list อันอื่น, ...
