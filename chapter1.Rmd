...
*** =sct
```{r}
test_output_contains("18", incorrect_msg = enc2utf8("ตรวจสอบให้แน่ใจว่าคุณได้พิมพ์ `6 + 12` ลงในบรรทัดใหม่ อย่าเริ่มต้นบรรทัดด้วยเครื่องหมาย `#` ไม่เช่นนั้นโค้ด R ของคุณจะไม่ถูกประมวลผล!"))
